 ...
 */
Ext.define('JavisERP.view.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        JavisERP.view.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        JavisERP.view.PortalDropZone.superclass.unreg.call(this);
    }
});
